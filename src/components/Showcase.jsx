            ...
            <div className='wrapper'>
                <div className='lg:max-w-md'>
                    ...
                    <div className='space-y-5 mt-7 pe-10'>
                        ...
                        <p>
                        A brand-new display engine delivers breathtaking precision, color accuracy, ano brightness. And a next-gen GPU with hardware-accelerated ray tracing brings console-level graphics to your fingertips.
                        </p>
